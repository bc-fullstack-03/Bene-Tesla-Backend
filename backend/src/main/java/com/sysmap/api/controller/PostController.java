...
public class PostController {
  ...
  //String updatePost(CreatePostResponse request);
  
  public ResponseEntity<String> updatePost(@RequestBody CreatePostRequest request) {
    var response = postService.updatePost(request);
    return ResponseEntity.status(HttpStatus.CREATED).body(response);
  }
